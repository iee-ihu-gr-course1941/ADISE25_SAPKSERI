...
3. Ο παίχτης ο οποίος έχει σειρά ρίχνει ένα χαρτί στο τραπέζι και μαζεύει τα φυλλα αν:
  1. το χαρτί του παίχτη είναι ίδιο με αυτό στο τραπέζι
  2. το χαρτί του παίχτι είναι βαλές
  3. ΞΕΡΗ: αν υπάρχει μόνο ένα φύλλο κάτω και ρίξει τοτε ο παίχτης το ιδιο τότε έχουμε ξερή!
...
### Αρχεία & Τρόπος Λειτουργίας

  **TheDryPeaks.php**: Το αρχείο TheDryPeaks.php είναι το entry point του API. Είναι το αρχείο το οποίο καλείται απο το frontend αν θέλει αν καλέσει μια συνάρτηση το frontend απο τον server. Υπάρχει ένα switch το οποίο ανακατευθυνει κατάλληλο κομματι του κώδικα. Για να καλέσουμε την συναρτηση getgame() που προαναφέραμε θα πρέπει να http://users.iee.ihu.gr/~iee2021152/TheDryPeaks.php/game/game με μέθοδο GET και με τα request ανάμεσα απο το τις '/' ανακατευυνομαστε στο κομματι κωδικα:
  '''php
